...
const posts = [
	...
	{
		title: 'learnweb utvecklar en kurs för pedagoger',
		slug: 'webbpedagogik',
		html: `
			<p>learnweb utvecklar en kurs i webbpedagogik. Vi vill ge pedagoger verktyg för att kunna skapa webbkurser.</p>
		`
	}
];
