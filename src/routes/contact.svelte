...
<div id="form-header">
  <h1>Kontakta oss</h1>
  <p>
    Vi skulle bli jätteglada om du tog kontakt med oss. Fyll i dina uppgifter så
    hör vi av oss så fort vi kan.
  </p>
</div>
<div class="contact-form">
  <form
    ...
    <div class="form-row">
      ...
      <input type="email" name="email" placeholder="kalle@exempel.se" />
    </div>
    <div class="form-row">
      <label style="align-self: flex-start; padding-top: 12px;">
        Meddelande
      </label>
      <textarea name="comment" maxlength="500" form="contact-form" placeholder="Berätta vad vi kan göra för dig" />
    </div>
